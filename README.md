...
> Lineage: 4 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 5 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\order-item-downloads](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\order-item-downloads) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package order-item-downloads -Apply
