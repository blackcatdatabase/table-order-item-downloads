...
final class OrderItemDownloadRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`order_item_downloads`' : '"order_item_downloads"';
     ...
     * [ 'order_id', 'book_id', 'asset_id' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'download_token_hash', 'token_key_version', 'key_version', 'max_uses', 'used', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $upd  = [ 'download_token_hash', 'token_key_version', 'key_version', 'max_uses', 'used', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ];
