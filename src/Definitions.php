...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'order_id', 'book_id', 'asset_id', 'download_token_hash', 'token_key_version', 'key_version', 'max_uses', 'used', 'is_active', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'order_id', 'book_id', 'asset_id' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }
    ...
    public static function generatedColumns(): array { return [ 'is_active' ]; }
    ...
    public static function piiColumns(): array { return [ 'ip_hash' ]; }
