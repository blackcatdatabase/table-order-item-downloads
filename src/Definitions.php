...
final class Definitions {
    ...
    public static function uniqueKeys(): array { return [ [ 'order_id', 'book_id', 'asset_id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'order_id', 'book_id', 'asset_id', 'max_uses', 'used' ]; }
