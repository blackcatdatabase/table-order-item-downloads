 ...
 * - whitelist filtrů: [ 'id', 'order_id', 'book_id', 'asset_id', 'download_token_hash', 'token_key_version', 'key_version', 'max_uses', 'used', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ]
 * - whitelist pro LIKE hledání: [ 'token_key_version', 'key_version', 'ip_hash_key_version' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'order_id', 'book_id', 'asset_id', 'download_token_hash', 'token_key_version', 'key_version', 'max_uses', 'used', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'token_key_version', 'key_version', 'ip_hash_key_version' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'order_id', 'book_id', 'asset_id', 'download_token_hash', 'token_key_version', 'key_version', 'max_uses', 'used', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ], true);
            $parts = [];
