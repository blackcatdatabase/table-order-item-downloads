...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'tenant_id', 'order_id', 'book_id', 'asset_id', 'download_token_hash', 'token_key_version', 'key_version', 'max_uses', 'used', 'is_active', 'expires_at', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ];
    }
    ...
    {
        $x = [ 'id', 'tenant_id', 'order_id', 'book_id', 'asset_id', 'token_key_version', 'key_version', 'max_uses', 'used', 'is_active', 'expires_at', 'last_used_at', 'ip_hash_key_version' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'tenants' => 'j0', 'orders' => 'j1', 'books' => 'j2', 'book_assets' => 'j3' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\OrderItemDownloads\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\OrderItemDownloads\Definitions::softDeleteColumn();
