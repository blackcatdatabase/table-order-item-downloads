...
namespace BlackCat\Database\Packages\OrderItemDownloads\Mapper;

use BlackCat\Database\Packages\OrderItemDownloads\Dto\OrderItemDownloadDto;
use BlackCat\Database\Packages\OrderItemDownloads\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO OrderItemDownloadDto:
...
final class OrderItemDownloadDtoMapper
{
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'expires_at', 'last_used_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'download_token_hash', 'ip_hash' ];
     ...
     * @return OrderItemDownloadDto
     */
    public static function fromRow(array $row): OrderItemDownloadDto
    {
        /** @var OrderItemDownloadDto */
        return DtoHydrator::fromRow(
            OrderItemDownloadDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?OrderItemDownloadDto
    {
     ...
     *
     * @param OrderItemDownloadDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(OrderItemDownloadDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(OrderItemDownloadDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(OrderItemDownloadDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,OrderItemDownloadDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,OrderItemDownloadDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(OrderItemDownloadDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,OrderItemDownloadDto>
     */
