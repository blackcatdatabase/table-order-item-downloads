...
final class OrderItemDownloadDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'order_id' => 'orderId', 'book_id' => 'bookId', 'asset_id' => 'assetId', 'download_token_hash' => 'downloadTokenHash', 'token_key_version' => 'tokenKeyVersion', 'key_version' => 'keyVersion', 'max_uses' => 'maxUses', 'expires_at' => 'expiresAt', 'last_used_at' => 'lastUsedAt', 'ip_hash' => 'ipHash', 'ip_hash_key_version' => 'ipHashKeyVersion' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'order_id', 'book_id', 'asset_id', 'max_uses', 'used' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'download_token_hash', 'token_key_version', 'key_version', 'last_used_at', 'ip_hash', 'ip_hash_key_version' ];
    ...
    public static function fromRow(array $row): OrderItemDownloadDto {
        ...
        return new OrderItemDownloadDto(...$vals);
    }
