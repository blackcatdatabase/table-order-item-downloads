...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_oid_tenant_expires_active', 'ux_oid_tenant_id', 'ux_oid_tenant_triplet' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_oid_tenant_expires_active', 'ux_oid_tenant_id', 'ux_oid_tenant_triplet' ],
