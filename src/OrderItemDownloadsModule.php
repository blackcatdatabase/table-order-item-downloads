...
final class OrderItemDownloadsModule implements ModuleInterface {
    ...
    /** @return string[] */
    public function dependencies(): array { return [ 'table-book_assets', 'table-books', 'table-orders' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_oid_download_token_hash', 'ux_oid_triplet' ];
        $fks     = [ 'fk_oid_asset', 'fk_oid_book', 'fk_oid_order' ];
        $missingIdx = [];
        $missingFk  = [];
