...
use BlackCat\Database\Packages\OrderItemDownloads\Repository\OrderItemDownloadRepository as GeneratedRepository;
...
{
  private OrderItemDownloadRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof OrderItemDownloadRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected OrderItemDownloadRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItemDownloads\Dto\OrderItemDownloadDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItemDownloads\Dto\OrderItemDownloadDto|null { return $this->repo->getById($id, $asDto); }
