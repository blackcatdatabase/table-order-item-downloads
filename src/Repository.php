...
{
    private OrderItemDownloadRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new OrderItemDownloadRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItemDownloads\Dto\OrderItemDownloadDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\OrderItemDownloads\Dto\OrderItemDownloadDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\OrderItemDownloads\Dto\OrderItemDownloadDto|null
    {
